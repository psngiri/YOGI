...
import yogi.paging.command.ExportTableDataCommand;
...
public class ExportTableDataCommandTestServer extends TestCase{

	public ExportTableDataCommandTestServer() throws CommandException {
		super();
	...
	public void testGetPage() throws CommandException {
		...
		ExportTableDataCommand<Recom> exportTableDataCommand = new ExportTableDataCommand<Recom>(0, ',', columnIndices,"AA123456");
		String data = (String) CommandExecutor.get().execute(exportTableDataCommand);
