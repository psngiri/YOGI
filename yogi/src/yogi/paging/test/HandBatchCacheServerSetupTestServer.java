...
public class HandBatchCacheServerSetupTestServer extends TestCase{

	HandBatchRecomSet recomSet;
	HandBatchRecomMapper recomMapper;
	TableData<Recom> tableData;

	ItemSet itemSet;
	ItemMapper itemMapper;
	HandBatchRecomMapper recomMapper1;
	
	HandBatchRecomSet recomSet1;
	...
	public void init() {
		...
		recomMapper = new HandBatchRecomMapper();
		recomSet = new HandBatchRecomSet();
		...
		recomMapper1 = new HandBatchRecomMapper();		
		recomSet1 = new HandBatchRecomSet();
	...
	public HandBatchCacheServerSetupTestServer() throws CommandException {
		super();
