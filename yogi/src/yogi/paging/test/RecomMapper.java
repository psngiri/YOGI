...
public class RecomMapper extends BaseTableDataMapper<Recom, Object> {
	...
	private static List<TableColumnConfig<?>>  constructTableColumnConfigs() {
		...
		tableColumnConfigs.add(new StringTableColumnConfig(		"Act", 			ColumnFieldType.COMBOBOX, 		34, false, 	true, 	true, true, 	ColumnAlignment.CENTER, 	ColumnFilterType.STRING, getActConfig(), getActValidator(), null));
		tableColumnConfigs.add(new StringTableColumnConfig(		"Orig", 		ColumnFieldType.TEXTFIELD, 		38, false, 	true, 	true, true, 	ColumnAlignment.CENTER, 	ColumnFilterType.STRING));
		tableColumnConfigs.add(new StringTableColumnConfig(		"Dest", 		ColumnFieldType.TEXTFIELD, 		40, false, 	true, 	true, true, 	ColumnAlignment.CENTER, 	ColumnFilterType.STRING));
		...
		tableColumnConfigs.add(new StringTableColumnConfig(		"Rtg", 			ColumnFieldType.TEXTFIELD, 		35, false, 	true, 	true, false, 	ColumnAlignment.RIGHT, 		ColumnFilterType.STRING));
		tableColumnConfigs.add(new StringNumberTableColumnConfig("FN", 			ColumnFieldType.TEXTFIELD, 		32, false, 	true, 	true, false, 	ColumnAlignment.CENTER, 	ColumnFilterType.STRING));
		tableColumnConfigs.add(new StringTableColumnConfig(		"Cur", 			ColumnFieldType.TEXTFIELD, 		36, false, 	true, 	true, false, 	ColumnAlignment.CENTER, 	ColumnFilterType.STRING));
		tableColumnConfigs.add(new FloatTableColumnConfig(		"Amt", 			ColumnFieldType.TEXTFIELD, 		61, false, 	true, 	true, false, 	ColumnAlignment.RIGHT, 		ColumnFilterType.STRING));
		tableColumnConfigs.add(new FloatTableColumnConfig(		"PrevAmt", 		ColumnFieldType.TEXTFIELD, 		61, true, 	true, 	true, false, 	ColumnAlignment.RIGHT, 		ColumnFilterType.STRING));
		tableColumnConfigs.add(new FloatTableColumnConfig(		"FareDiff", 	ColumnFieldType.TEXTFIELD, 		57, true, 	true, 	true, false, 	ColumnAlignment.RIGHT, 		ColumnFilterType.STRING));
