...
public class RevertMultipleAddedTableRowCommand<T> extends CommandAdapter<Boolean> {	
	...
	public RevertMultipleAddedTableRowCommand(int tableDataSetId, Changes changes, List<Integer> rowIndices, String userId) {
		super(userId);
	...
	public Boolean execute() {
		...
		return tableData.revertAddedRows(rowIndices);
	}
