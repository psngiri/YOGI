...
public class PercentFractionDoubleFormatter implements Formatter<FractionDouble>, Serializable {
	...
	public String format(FractionDouble object) {
		...
		String format = String.format("%0" + position + "." + decimal + "f", object.getValue()*100);
		return format;
	}
	
	public PercentFractionDoubleFormatter(int position, int decimal) {
		super();
