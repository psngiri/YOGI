...
import yogi.report.dated.group.TreeDatedColumnGroupBy;
...
public class IntervalReportViewerTestCase
{
...
//		ColumnDefinition<Item> column10= new DayOfMonthColumn<Item>();
		...
		TreeDatedColumnGroupBy<Item> treeGroupBy = new TreeDatedColumnGroupBy<Item>(column1, column2, column9, column7, column10);
		treeGroupBy.getGroupBy().setIntervalEvaluator(new DatedIntervalEvaluator());
		reportTemplate.addGroupBys(treeGroupBy.getGroupBys());
	...
	private static void addIntervals(List<yogi.report.viewer.test.IntervalReportViewerTestCase.Item> items) {
