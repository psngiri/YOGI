...
public class TemplateCompareGroupFooter<T> implements MultiLineFormatter<CompareGroup<T>> {
	private CompareReportTemplate<T> reportTemplate;
	private boolean drawLines = true;
	
	public TemplateCompareGroupFooter(CompareReportTemplate<T> reportTemplate) {
		super();
