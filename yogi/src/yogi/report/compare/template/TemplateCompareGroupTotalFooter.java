...
public class TemplateCompareGroupTotalFooter<T> implements MultiLineFormatter<CompareGroup<T>> {
	private CompareReportTemplate<T> reportTemplate;
	private boolean drawLines = true;
	
	public TemplateCompareGroupTotalFooter(CompareReportTemplate<T> reportTemplate) {
		super();
