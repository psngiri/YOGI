...
public class TemplateCompareGroupTotalHeader<T> implements MultiLineFormatter<CompareGroup<T>> {
	private CompareReportTemplate<T> reportTemplate;
	private boolean drawLines = true;
	
	public TemplateCompareGroupTotalHeader(CompareReportTemplate<T> reportTemplate) {
		super();
