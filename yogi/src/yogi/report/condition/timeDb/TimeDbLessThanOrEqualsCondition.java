...
public class TimeDbLessThanOrEqualsCondition extends LongLessThanOrEqualsCondition {
	private Formatter<Long> sqlFormatter;
	
	public TimeDbLessThanOrEqualsCondition(String value,Formatter<Long> sqlFormatter) {
		super(value);
