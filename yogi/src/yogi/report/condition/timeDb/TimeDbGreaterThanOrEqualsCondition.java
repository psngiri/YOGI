...
public class TimeDbGreaterThanOrEqualsCondition extends LongGreaterThanOrEqualsCondition {
	private Formatter<Long> sqlFormatter;
	
	public TimeDbGreaterThanOrEqualsCondition(String value,Formatter<Long> sqlFormatter) {
		super(value);
