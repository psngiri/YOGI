...
public class DateRangeIntersectsCondition extends ConditionBaseImpl<DateRange> {
	private static DateRangeScanner scanner = new DateRangeScanner(new DDMMMYYDateScanner(), '-');
	private List<DateRange> ranges;
	public DateRangeIntersectsCondition(String value) {
		super(value);
