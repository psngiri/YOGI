...
public class DateDbLessThanOrEqualsCondition extends LongLessThanOrEqualsCondition {
private Formatter<Long> sqlFormatter;
	
	public DateDbLessThanOrEqualsCondition(String value,Formatter<Long> sqlFormatter) {
		super(value);
