...
public class StringNumberNotInConditionConfig extends ConditionConfig<String> {

	private static final long serialVersionUID = 1L;

	public StringNumberNotInConditionConfig() {
		super("NotIn", new StringNumberInValidator());
	}

	public StringNumberNotInConditionConfig(BaseValidator validator) {
