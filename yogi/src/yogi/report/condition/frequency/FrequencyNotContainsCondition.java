...
public class FrequencyNotContainsCondition extends ConditionBaseImpl<Frequency> {
	private Frequency frequency;
	
	public FrequencyNotContainsCondition(String value, Scanner<Frequency, String> scanner) {
		super(value);
