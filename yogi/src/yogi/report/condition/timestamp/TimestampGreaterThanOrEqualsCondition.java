...
public class TimestampGreaterThanOrEqualsCondition extends LongGreaterThanOrEqualsCondition {
private Formatter<Long> sqlFormatter;
	
	public TimestampGreaterThanOrEqualsCondition(String value, Formatter<Long> sqlFormatter) {
		super(value);
