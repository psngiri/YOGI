...
public class TimestampGreaterThanCondition extends LongGreaterThanCondition {
	private Formatter<Long> sqlFormatter;
	
	public TimestampGreaterThanCondition(String value, Formatter<Long> sqlFormatter) {
		super(value);
