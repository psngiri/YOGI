...
public class TimestampLessThanOrEqualsCondition extends LongLessThanOrEqualsCondition {
	private Formatter<Long> sqlFormatter;
	
	public TimestampLessThanOrEqualsCondition(String value, Formatter<Long> sqlFormatter) {
		super(value);
