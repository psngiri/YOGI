...
public class ReportClientApplication {
	...
	public static void main(String[] args) {
		...
		ReportClientApplication.ServerIpPortNumber = args[0];
//		ReportClientQuery.UserId = args[1];
//		ReportClientQuery.Partition = args[2];
//		ReportClientQuery.Query = args[3];
	...
	public static String[][] executeQuery(ReportClientQuery riQuery) {
		...
		url = String.format("http://%s/JAFWebApp/CommandServlet?ServerType=Strategy&Key=yogi.server.gui.report.command.GenerateReportServiceCommand&Value="+json,ServerIpPortNumber);		
		try {
